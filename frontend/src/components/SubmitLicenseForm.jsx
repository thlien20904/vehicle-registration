  ...
  return (
    <div style={modalOverlayStyle}>
      <div style={modalContentStyle}>
        ...
        <p>
          <strong>Tên Công ty:</strong> {license.companyName}
        </p>
        <p>
          <strong>Địa chỉ:</strong> {license.companyAddress}
        </p>
        <p>
          ...
          <span
            style={{
              fontWeight: "bold",
              color:
                license.status === "ĐÃ DUYỆT"
                  ? "green"
                  : license.status === "BỊ TỪ CHỐI"
                  ? "red"
                  : "orange",
            }}
          >
        ...
        <p>
          <strong>IPFS Hash:</strong> {license.ipfsHash}
        </p>
        <a
          href={`http://127.0.0.1:8080/ipfs/${license.ipfsHash}`}
          target="_blank"
...
const SubmitLicenseForm = ({ signer, account, onSubmission, provider }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Lỗi nộp hồ sơ. Kiểm tra Metamask (đủ gas), Hardhat Node và IPFS Desktop."
      );
    } finally {
      ...
      <div style={formContainerStyle}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={inputGroupStyle}>
            ...
            <div style={customFileInputContainerStyle}>
              {" "}
              {/* Container mới */}
              <input
                type="file"
