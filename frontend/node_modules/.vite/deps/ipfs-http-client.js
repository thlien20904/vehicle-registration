...
var require_base64 = __commonJS({
  "node_modules/@protobufjs/base64/index.js"(exports2) {
    ...
    var i;
    base645.encode = function encode29(buffer2, start, end) {
    ...
    module2.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "ipfs-utils/src/files/glob-source.js" has been externalized for browser compatibility. Cannot access "ipfs-utils/src/files/glob-source.js.${key}" in client code. See http://vitejs.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
function from({ name: name10, prefix, encode: encode29, decode: decode39 }) {
  return new Codec(name10, prefix, encode29, decode39);
}
function baseX({ name: name10, prefix, alphabet: alphabet4 }) {
  const { encode: encode29, decode: decode39 } = base_x_default(alphabet4, name10);
  return from({
    prefix,
    name: name10,
    encode: encode29,
...
function decode(string3, alphabetIdx, bitsPerChar, name10) {
...
function createAlphabetIdx(alphabet4) {
  const alphabetIdx = {};
  for (let i = 0; i < alphabet4.length; ++i) {
    alphabetIdx[alphabet4[i]] = i;
  }
  return alphabetIdx;
}
function rfc4648({ name: name10, prefix, bitsPerChar, alphabet: alphabet4 }) {
  const alphabetIdx = createAlphabetIdx(alphabet4);
  return from({
    prefix,
    name: name10,
    encode(input) {
    ...
    decode(input) {
      return decode(input, alphabetIdx, bitsPerChar, name10);
    }
  });
}
...
// node_modules/@ipld/dag-pb/node_modules/multiformats/dist/src/link/interface.js
init_process();
init_buffer();
...
function from2({ name: name10, prefix, encode: encode29, decode: decode39 }) {
  return new Codec2(name10, prefix, encode29, decode39);
}
function baseX2({ name: name10, prefix, alphabet: alphabet4 }) {
  const { encode: encode29, decode: decode39 } = base_x_default2(alphabet4, name10);
  return from2({
    prefix,
    name: name10,
    encode: encode29,
...
function decode7(string3, alphabetIdx, bitsPerChar, name10) {
  let end = string3.length;
  while (string3[end - 1] === "=") {
    --end;
  }
...
function createAlphabetIdx2(alphabet4) {
  const alphabetIdx = {};
  for (let i = 0; i < alphabet4.length; ++i) {
    alphabetIdx[alphabet4[i]] = i;
  }
...
function rfc46482({ name: name10, prefix, bitsPerChar, alphabet: alphabet4 }) {
  const alphabetIdx = createAlphabetIdx2(alphabet4);
  return from2({
    prefix,
    name: name10,
    encode(input) {
    ...
    decode(input) {
      return decode7(input, alphabetIdx, bitsPerChar, name10);
    }
  });
}
...
// node_modules/@ipld/dag-cbor/node_modules/multiformats/dist/src/link/interface.js
init_process();
init_buffer();
...
function from3({ name: name10, prefix, encode: encode29, decode: decode39 }) {
  return new Codec3(name10, prefix, encode29, decode39);
}
function baseX3({ name: name10, prefix, alphabet: alphabet4 }) {
  const { encode: encode29, decode: decode39 } = base_x_default3(alphabet4, name10);
  return from3({
    prefix,
    name: name10,
    encode: encode29,
...
function decode13(string3, alphabetIdx, bitsPerChar, name10) {
  let end = string3.length;
  while (string3[end - 1] === "=") {
    --end;
  }
...
function createAlphabetIdx3(alphabet4) {
  const alphabetIdx = {};
  for (let i = 0; i < alphabet4.length; ++i) {
    alphabetIdx[alphabet4[i]] = i;
  }
...
function rfc46483({ name: name10, prefix, bitsPerChar, alphabet: alphabet4 }) {
  const alphabetIdx = createAlphabetIdx3(alphabet4);
  return from3({
    prefix,
    name: name10,
    encode(input) {
    ...
    decode(input) {
      return decode13(input, alphabetIdx, bitsPerChar, name10);
    }
  });
}
...
var from4 = ({ name: name10, prefix, encode: encode29, decode: decode39 }) => new Codec4(name10, prefix, encode29, decode39);
var baseX4 = ({ prefix, name: name10, alphabet: alphabet4 }) => {
  const { encode: encode29, decode: decode39 } = base_x_default4(alphabet4, name10);
  return from4({
    prefix,
    name: name10,
    encode: encode29,
...
init_process();
init_buffer();
var from5 = ({ name: name10, code: code10, encode: encode29 }) => new Hasher(name10, code10, encode29);
var Hasher = class {
  /**
   *
   * @param {Name} name
...
var from6 = ({ name: name10, prefix, encode: encode29, decode: decode39 }) => new Codec5(name10, prefix, encode29, decode39);
var baseX5 = ({ prefix, name: name10, alphabet: alphabet4 }) => {
  const { encode: encode29, decode: decode39 } = base_x_default5(alphabet4, name10);
  return from6({
    prefix,
    name: name10,
    encode: encode29,
...
init_process();
init_buffer();
var from7 = ({ name: name10, code: code10, encode: encode29 }) => new Hasher2(name10, code10, encode29);
var Hasher2 = class {
  /**
   *
   * @param {Name} name
...
// node_modules/uint8arrays/dist/src/util/bases.js
function createCodec(name10, prefix, encode29, decode39) {
  return {
    name: name10,
    prefix,
    encoder: {
...
function parse2(str = "", format8 = "ms") {
  ...
  str.replace(durationRE, function(_, n, units) {
    ...
    if (units)
      result = (result || 0) + Math.abs(parseFloat(n, 10)) * units, prevUnits = units;
  });
  return result && result / (parse2[format8] || 1) * (str[0] === "-" ? -1 : 1);
}
...
function from8({ name: name10, prefix, encode: encode29, decode: decode39 }) {
  return new Codec6(name10, prefix, encode29, decode39);
}
function baseX6({ name: name10, prefix, alphabet: alphabet4 }) {
  const { encode: encode29, decode: decode39 } = base_x_default6(alphabet4, name10);
  return from8({
    prefix,
    name: name10,
    encode: encode29,
...
function decode33(string3, alphabetIdx, bitsPerChar, name10) {
  let end = string3.length;
  while (string3[end - 1] === "=") {
    --end;
  }
...
function createAlphabetIdx4(alphabet4) {
  const alphabetIdx = {};
  for (let i = 0; i < alphabet4.length; ++i) {
    alphabetIdx[alphabet4[i]] = i;
  }
...
function rfc46486({ name: name10, prefix, bitsPerChar, alphabet: alphabet4 }) {
  const alphabetIdx = createAlphabetIdx4(alphabet4);
  return from8({
    prefix,
    name: name10,
    encode(input) {
    ...
    decode(input) {
      return decode33(input, alphabetIdx, bitsPerChar, name10);
    }
  });
}
...
// node_modules/@multiformats/multiaddr-to-uri/node_modules/multiformats/dist/src/varint.js
function decode36(data, offset = 0) {
...
function decode37(multihash) {
  const bytes = coerce6(multihash);
  const [code10, sizeOffset] = decode36(bytes);
  const [size, digestOffset] = decode36(bytes.subarray(sizeOffset));
  const digest4 = bytes.subarray(sizeOffset + digestOffset);
  if (digest4.byteLength !== size) {
    throw new Error("Incorrect length");
  }
...
function from9({ name: name10, code: code10, encode: encode29, minDigestLength, maxDigestLength }) {
  return new Hasher3(name10, code10, encode29, minDigestLength, maxDigestLength);
}
var Hasher3 = class {
  constructor(name10, code10, encode29, minDigestLength, maxDigestLength) {
    __publicField(this, "name");
    __publicField(this, "code");
...
var CID6 = class _CID {
  ...
  static asCID(input) {
    ...
    if (value instanceof _CID) {
      ...
      const { version, multihash, code: code10 } = value;
      const digest4 = decode37(multihash);
      return _CID.create(version, code10, digest4);
    } else {
      return null;
    }
  ...
  static inspectBytes(initialBytes) {
    let offset = 0;
    const next = () => {
      const [i, length7] = decode36(initialBytes.subarray(offset));
      offset += length7;
      return i;
    };
    let version = next();
...
// node_modules/@multiformats/multiaddr-to-uri/node_modules/uint8arrays/dist/src/util/bases.js
function createCodec2(name10, prefix, encode29, decode39) {
  return {
    name: name10,
    prefix,
    encoder: {
...
init_process();
init_buffer();
function bytesToString2(base7) {
  return (buf2) => {
    return toString7(buf2, base7);
  };
}
function stringToBytes2(base7) {
  return (buf2) => {
    return fromString7(buf2, base7);
  };
}
...
function bytes2mb2(base7) {
  return (buf2) => {
    return base7.encoder.encode(buf2);
  };
}
...
var Registry = class {
  ...
  addProtocol(codec) {
    ...
    (_a8 = codec.aliases) == null ? void 0 : _a8.forEach((alias) => {
...
var codecs2 = [{
  ...
  valueToBytes: (val) => {
    ...
    return CID6.parse(val).multihash.bytes;
  }
}, {
  code: CODE_ONION,
  name: "onion",
  ...
  name: "certhash",
  size: V2,
  bytesToValue: bytes2mb2(base64url4),
...
function bytesToComponents(bytes) {
  ...
  while (i < bytes.length) {
    ...
    if (size > 0) {
      ...
      component.value = ((_a8 = codec.bytesToValue) == null ? void 0 : _a8.call(codec, valueBytes)) ?? toString7(valueBytes);
    }
...
function componentsToBytes(components) {
  ...
  for (const component of components) {
    if (component.bytes == null) {
      ...
      const codecLength = encodingLength7(component.code);
      let valueBytes;
      let valueLength = 0;
      let valueLengthLength = 0;
      if (component.value != null) {
        valueBytes = ((_a8 = codec.valueToBytes) == null ? void 0 : _a8.call(codec, component.value)) ?? fromString7(component.value);
        valueLength = valueBytes.byteLength;
        if (codec.size === V2) {
          valueLengthLength = encodingLength7(valueLength);
        }
      }
    ...
    length7 += component.bytes.byteLength;
  }
  return concat3(bytes, length7);
}
    ...
    if (char === "/" || ended) {
      ...
      if (collecting === "protocol") {
        ...
        if (codec.size != null && codec.size !== 0) {
          ...
          component.value = ((_a8 = codec.stringToValue) == null ? void 0 : _a8.call(codec, value)) ?? value;
        }
        components.push(component);
        value = "";
        protocol = "";
...
function componentsToString(components) {
  return `/${components.flatMap((component) => {
    ...
    return [
      component.name,
      ((_a8 = codec.valueToString) == null ? void 0 : _a8.call(codec, component.value)) ?? component.value
    ];
  }).join("/")}`;
}
...
var _a6, _components, _string, _bytes;
var _Multiaddr = class _Multiaddr {
  ...
  toOptions() {
    ...
    let port;
    let zone = "";
    for (const { code: code10, name: name10, value } of __privateGet(this, _components)) {
  ...
  protos() {
    return __privateGet(this, _components).map(({ code: code10, value }) => {
      const codec = registry.getProtocol(code10);
      return {
        code: code10,
        size: codec.size ?? 0,
  ...
  tuples() {
    return __privateGet(this, _components).map(({ code: code10, value }) => {
      ...
      const output = [code10];
      if (value != null) {
        output.push(((_a8 = codec.valueToBytes) == null ? void 0 : _a8.call(codec, value)) ?? fromString7(value));
      }
      return output;
    });
  }
  ...
  getPeerId() {
    try {
      let tuples = [];
      __privateGet(this, _components).forEach(({ code: code10, value }) => {
        if (code10 === CODE_P2P) {
          tuples.push([code10, value]);
        }
...
function validate3(addr) {
  addr.getComponents().forEach((component) => {
    ...
    (_a8 = codec.validate) == null ? void 0 : _a8.call(codec, component.value);
  });
}
...
function multiaddrToUri(input, opts) {
  ...
  if ((opts == null ? void 0 : opts.assumeHttp) !== false && head[0] === protocols("tcp").code) {
...
var Data = $root.Data = (() => {
  ...
  Data2.encode = function encode29(m, w) {
    if (!w)
      w = $Writer.create();
...
var UnixTime = $root.UnixTime = (() => {
  ...
  UnixTime2.encode = function encode29(m, w) {
    if (!w)
      w = $Writer.create();
...
var Metadata = $root.Metadata = (() => {
  ...
  Metadata2.encode = function encode29(m, w) {
    if (!w)
      w = $Writer.create();
